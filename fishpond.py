...
if __name__ == '__main__':
    ...
    parser.add_argument('daun_column_num', type=int, help='Daun column number')
    parser.add_argument('parcel_column_num', type=int, help='Parcel column number')
    parser.add_argument('county', type=str, help='County of the csv')
    parser.add_argument('town', type=str, help='Town of the csv')
